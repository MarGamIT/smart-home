...
export class ControlService {
  ...
  public async createHomeAsync(homeData: Home): Promise<Home | null> {
    ...
    await this.http.post('http://localhost:3000/home', homeData).toPromise().then((response: any) => {
  ...
  public async updateHomeAsync(home: Home): Promise<boolean> {
    ...
    await this.http.put('http://localhost:3000/home/' + home.id, home).toPromise().then((response: any) => {
